...
namespace TacoEditor.GameProject
{
    ...
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\TacoEditor\";
        ...
        private static void ReadProjectData()
        {
            if(File.Exists(_projectDataPath))
            {
                ...
                foreach(var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.Taco\icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Taco\screenshot.png");
